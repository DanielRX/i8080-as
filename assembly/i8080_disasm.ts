...
import {hex16, hex8} from './utils';


export function i8080_disasm(binary: u8[]): string {
  let opcode = binary[0];
  let imm8: u8 = binary[1];
  let imm16: u16  = imm8 | (binary[2] << 8);
  let cmd: string;
  let length: u8;
  let arg1: string;
  let arg2: string; 
  ...
  const imm8Str = hex8(imm8);
  const imm16Str = hex16(imm16);
  ...
  switch (opcode) {
    ...
    case 0x01: cmd = "LXI";   length = 3; arg1 = "B"; arg2 = imm16Str; data2 = true; break;
    ...
    case 0x06: cmd = "MVI";   length = 2; arg1 = "B"; arg2 = imm8Str; break;
    ...
    case 0x0e: cmd = "MVI";   length = 2; arg1 = "C"; arg2 = imm8Str; break;
    case 0x0f: cmd = "RRC";   length = 1; break;

    case 0x11: cmd = "LXI";   length = 3; arg1 = "D"; arg2 = imm16Str; data2 = true; break;
    ...
    case 0x16: cmd = "MVI";   length = 2; arg1 = "D"; arg2 = imm8Str; break;
    ...
    case 0x1e: cmd = "MVI";   length = 2; arg1 = "E"; arg2 = imm8Str; break;
    case 0x1f: cmd = "RAR";   length = 1; break;

    case 0x21: cmd = "LXI";   length = 3; arg1 = "H"; arg2 = imm16Str; data2 = true; break;
    case 0x22: cmd = "SHLD";  length = 3; arg1 = imm16Str; data1 = true; break;
    case 0x23: cmd = "INX";   length = 1; arg1 = "H"; break;
    case 0x24: cmd = "INR";   length = 1; arg1 = "H"; break;
    case 0x25: cmd = "DCR";   length = 1; arg1 = "H"; break;
    case 0x26: cmd = "MVI";   length = 2; arg1 = "H"; arg2 = imm8Str; break;
    case 0x27: cmd = "DAA";   length = 1; break;
    case 0x29: cmd = "DAD";   length = 1; arg1 = "H"; break;
    case 0x2a: cmd = "LHLD";  length = 3; arg1 = imm16Str; data1 = true; break;
    case 0x2b: cmd = "DCX";   length = 1; arg1 = "H"; break;
    case 0x2c: cmd = "INR";   length = 1; arg1 = "L"; break;
    case 0x2d: cmd = "DCR";   length = 1; arg1 = "L"; break;
    case 0x2e: cmd = "MVI";   length = 2; arg1 = "L"; arg2 = imm8Str; break;
    case 0x2f: cmd = "CMA";   length = 1; break;

    case 0x31: cmd = "LXI";   length = 3; arg1 = "SP"; arg2 = imm16Str; data2 = true; break;
    case 0x32: cmd = "STA";   length = 3; arg1 = imm16Str; data1 = true; break;
    case 0x33: cmd = "INX";   length = 1; arg1 = "SP"; break;
    case 0x34: cmd = "INR";   length = 1; arg1 = "M"; break;
    case 0x35: cmd = "DCR";   length = 1; arg1 = "M"; break;
    case 0x36: cmd = "MVI";   length = 2; arg1 = "M"; arg2 = imm8Str; break;
    case 0x37: cmd = "STC";   length = 1; break;
    case 0x39: cmd = "DAD";   length = 1; arg1 = "SP"; break;
    case 0x3a: cmd = "LDA";   length = 3; arg1 = imm16Str; data1 = true; break;
    case 0x3b: cmd = "DCX";   length = 1; arg1 = "SP"; break;
    case 0x3c: cmd = "INR";   length = 1; arg1 = "A"; break;
    case 0x3d: cmd = "DCR";   length = 1; arg1 = "A"; break;
    case 0x3e: cmd = "MVI";   length = 2; arg1 = "A"; arg2 = imm8Str; break;
    case 0x3f: cmd = "CMC";   length = 1; break;

    case 0x76: cmd = "HLT";   length = 1; break;

    case 0xc3: cmd = "JMP";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xcb: cmd = "JMP?";  length = 3; arg1 = imm16Str; branch = true; bad = true; break;

    case 0xcd: cmd = "CALL";  length = 3; arg1 = imm16Str; branch = true; break;
    case 0xfd: cmd = "CALL?"; length = 3; arg1 = imm16Str; branch = true; bad = true; break;
    ...
    case 0xc2: cmd = "JNZ";   length = 3; arg1 = imm16Str; branch = true; break;

    case 0xc3: cmd = "JMP";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xcb: cmd = "JMP?";  length = 3; arg1 = imm16Str; branch = true; bad = true; break;

    case 0xc4: cmd = "CNZ";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xc5: cmd = "PUSH";  length = 1; arg1 = "B"; break;
    case 0xc6: cmd = "ADI";   length = 2; arg1 = imm8Str; break;
    ...
    case 0xca: cmd = "JZ";    length = 3; arg1 = imm16Str; branch = true; break;
    case 0xcc: cmd = "CZ";    length = 3; arg1 = imm16Str; branch = true; break;

    case 0xcd: cmd = "CALL";  length = 3; arg1 = imm16Str; branch = true; break;
    case 0xdd: cmd = "CALL?"; length = 3; arg1 = imm16Str; branch = true; bad = true; break;
    case 0xed: cmd = "CALL?"; length = 3; arg1 = imm16Str; branch = true; bad = true; break;
    case 0xfd: cmd = "CALL?"; length = 3; arg1 = imm16Str; branch = true; bad = true; break;

    case 0xce: cmd = "ACI";   length = 2; arg1 = imm8Str; break;
    case 0xcf: cmd = "RST";   length = 1; arg1 = "1"; break;
    case 0xd0: cmd = "RNC";   length = 1; break;
    case 0xd1: cmd = "POP";   length = 1; arg1 = "D"; break;
    case 0xd2: cmd = "JNC";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xd3: cmd = "OUT";   length = 2; arg1 = imm8Str; break;
    case 0xd4: cmd = "CNC";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xd5: cmd = "PUSH";  length = 1; arg1 = "D"; break;
    case 0xd6: cmd = "SUI";   length = 2; arg1 = imm8Str; break;
    case 0xd7: cmd = "RST";   length = 1; arg1 = "2"; break;
    case 0xd8: cmd = "RC";    length = 1; break;
    case 0xda: cmd = "JC";    length = 3; arg1 = imm16Str; branch = true; break;
    case 0xdb: cmd = "IN";    length = 2; arg1 = imm8Str; break;
    case 0xdc: cmd = "CC";    length = 3; arg1 = imm16Str; branch = true; break;
    case 0xde: cmd = "SBI";   length = 2; arg1 = imm8Str; break;
    case 0xdf: cmd = "RST";   length = 1; arg1 = "3"; break;
    case 0xe0: cmd = "RPO";   length = 1; break;
    case 0xe1: cmd = "POP";   length = 1; arg1 = "H"; break;
    case 0xe2: cmd = "JPO";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xe3: cmd = "XTXL";  length = 1; break;
    case 0xe4: cmd = "CPO";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xe5: cmd = "PUSH";  length = 1; arg1 = "H"; break;
    case 0xe6: cmd = "ANI";   length = 2; arg1 = imm8Str; break;
    case 0xe7: cmd = "RST";   length = 1; arg1 = "4"; break;
    case 0xe8: cmd = "RPE";   length = 1; break;
    case 0xe9: cmd = "PCHL";  length = 1; break;
    case 0xea: cmd = "JPE";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xeb: cmd = "XCHG";  length = 1; break;
    case 0xec: cmd = "CPE";   length = 3; arg1 = imm16Str; branch = true; break;
    case 0xee: cmd = "XRI";   length = 2; arg1 = imm8Str; break;
    case 0xef: cmd = "RST";   length = 1; arg1 = "5"; break;
    case 0xf0: cmd = "RP";    length = 1; break;
    case 0xf1: cmd = "POP";   length = 1; arg1 = "PSW"; break;
    case 0xf2: cmd = "JP";    length = 3; arg1 = imm16Str; branch = true; break;
    case 0xf3: cmd = "DI";    length = 1; break;
    case 0xf4: cmd = "CP";    length = 3; arg1 = imm16Str; branch = true; break;
    case 0xf5: cmd = "PUSH";  length = 1; arg1 = "PSW"; break;
    case 0xf6: cmd = "ORI";   length = 2; arg1 = imm8Str; break;
    case 0xf7: cmd = "RST";   length = 1; arg1 = "6"; break;
    case 0xf8: cmd = "RM";    length = 1; break;
    case 0xf9: cmd = "SPHL";  length = 1; break;
    case 0xfa: cmd = "JM";    length = 3; arg1 = imm16Str; branch = true; break;
    case 0xfb: cmd = "EI";    length = 1; break;
    case 0xfc: cmd = "CM";    length = 3; arg1 = imm16Str; branch = true; break;
    case 0xfe: cmd = "CPI";   length = 2; arg1 = imm8Str; break;
